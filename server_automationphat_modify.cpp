...
const int OUTPUT_3 = 31;
const int INPUT_1 = 37;
const int INPUT_2 = 38;
const int INPUT_3 = 40;
const int RELAY_1 = 33;
const int RELAY_2 = 35;
...
/*
 * class definition for class that handles /CommsLight
 *
...
*/
class CommslightResource : public Resource
{
    public:
        /*
         * constructor
         ...
         * @param resourceUri the uri for this resource
         */
        CommslightResource(std::string resourceUri = "/CommsLight");

        /*
         * destructor
         */
         virtual ~CommslightResource(void);
...
int ledPin = COMMS_LIGHT;

    private:

        /*
         * Make the payload for the retrieve function (e.g. GET) /CommsLight
         * This resource describes a binary switch (on/off).
         * The value is a boolean.
         * A value of 'true' means that the switch is on.
         * A value of 'false' means that the switch is off.
        ...
        /*
         * Parse the payload for the update function (e.g. POST) /CommsLight
        ...
        // member variables for path: "/CommsLight"
        std::vector<std::string>  m_var_value_if; // the value for the array attribute "if": The interface set supported by this resource
        std::string m_var_name_if = "if"; // the name for the attribute "if"
        std::string m_var_value_n; // the value for the attribute "n": Friendly name of the resource
        std::string m_var_name_n = "n"; // the name for the attribute "n"
...
* Constructor code
*/
CommslightResource::CommslightResource(std::string resourceUri)
{
    std::cout << "- Running: CommslightResource constructor" << std::endl;
...
{
    OCStackResult result = OC_STACK_ERROR;
    EntityHandler cb = std::bind(&CommslightResource::entityHandler, this,PH::_1);
    result = OCPlatform::registerResource(m_resourceHandle,
                                          m_resourceUri,
                                          m_RESOURCE_TYPE[0],
                                          m_RESOURCE_INTERFACE[0],
    ...
    if(OC_STACK_OK != result)
    {
        std::cerr << "Failed to register CommslightResource." << std::endl;
        return result;
    }
    ...
    std::cout << "CommslightResource:" << std::endl;
    std::cout << "\t" << "# resource interfaces: "
              << sizeof(m_RESOURCE_INTERFACE)/sizeof(m_RESOURCE_INTERFACE[0]) << std::endl;
    std::cout << "\t" << "# resource types     : "
              << sizeof(m_RESOURCE_TYPE)/sizeof(m_RESOURCE_TYPE[0]) << std::endl;
...
OCStackResult CommslightResource::sendNotification(void)
{
    OCStackResult sResult = OC_STACK_OK;
    if ( m_interestedObservers.size() > 0) {
        std::cout << "Notifying list "  << m_interestedObservers.size() << " of observers\n";
...
* @param queries  the query parameters for this call
*/
OCRepresentation CommslightResource::get(QueryParamsMap queries)
{
    OC_UNUSED(queries);
...
* @return OCEntityHandlerResult ok or not ok indication
*/
OCEntityHandlerResult CommslightResource::post(QueryParamsMap queries, const OCRepresentation& rep)
{
...
* Check if the interface name is an registered interface name
*/
bool CommslightResource::in_updatable_interfaces(std::string interface_name)
{
    for (unsigned int i=0; i < (sizeof(m_IF_UPDATE)/sizeof(m_IF_UPDATE[0])); i++)
    {
        if (m_IF_UPDATE[i].compare(interface_name) == 0)
...
* the entity handler
*/
OCEntityHandlerResult CommslightResource::entityHandler(std::shared_ptr<OCResourceRequest> request)
{
    OCEntityHandlerResult ehResult = OC_EH_ERROR;
    //std::cout << "In entity handler for CommslightResource " << std::endl;

    if(request)
    {
        std::cout << "In entity handler for CommslightResource, URI is : "
                  << request->getResourceUri() << std::endl;
        ...
        if(requestFlag & RequestHandlerFlag::RequestFlag)
        {
            ...
            if(request->getRequestType() == "GET")
            {
                std::cout<<"CommslightResource Get Request"<< std::endl;
            ...
            {
                std::cout <<"CommslightResource Post Request"<<std::endl;
            ...
            {
                std::cout << "CommslightResource unsupported request type (delete,put,..)"
                    << request->getRequestType() << std::endl;
                pResponse->setResponseResult(OC_EH_ERROR);
                OCPlatform::sendResponse(pResponse);
                ehResult = OC_EH_ERROR;
...
/*
 * class definition for class that handles /PowerLight
 *
 * This resource describes a binary switch (on/off).
 * The value is a boolean.
 * A value of 'true' means that the switch is on.
...
*/
class PowerlightResource : public Resource
{
    public:
        /*
         * constructor
         ...
         * @param resourceUri the uri for this resource
         */
        PowerlightResource(std::string resourceUri = "/PowerLight");

        /*
         * destructor
         */
         virtual ~PowerlightResource(void);
    ...
    private:
        ...
        /*
         * Make the payload for the retrieve function (e.g. GET) /PowerLight
         * This resource describes a binary switch (on/off).
         * The value is a boolean.
         * A value of 'true' means that the switch is on.
         * A value of 'false' means that the switch is off.
        ...
        /*
         * Parse the payload for the update function (e.g. POST) /PowerLight
        ...
        // member variables for path: "/PowerLight"
        std::vector<std::string>  m_var_value_if; // the value for the array attribute "if": The interface set supported by this resource
        std::string m_var_name_if = "if"; // the name for the attribute "if"
        std::string m_var_value_n; // the value for the attribute "n": Friendly name of the resource
        std::string m_var_name_n = "n"; // the name for the attribute "n"
...
* Constructor code
*/
PowerlightResource::PowerlightResource(std::string resourceUri)
{
    std::cout << "- Running: PowerlightResource constructor" << std::endl;
...
* Destructor code
*/
PowerlightResource::~PowerlightResource() { }

OCStackResult PowerlightResource::registerResource(uint8_t resourceProperty)
{
    OCStackResult result = OC_STACK_ERROR;
    EntityHandler cb = std::bind(&PowerlightResource::entityHandler, this,PH::_1);
    result = OCPlatform::registerResource(m_resourceHandle,
                                          m_resourceUri,
                                          m_RESOURCE_TYPE[0],
                                          m_RESOURCE_INTERFACE[0],
    ...
    if(OC_STACK_OK != result)
    {
        std::cerr << "Failed to register PowerlightResource." << std::endl;
        return result;
    }
    ...
    std::cout << "PowerlightResource:" << std::endl;
    std::cout << "\t" << "# resource interfaces: "
              << sizeof(m_RESOURCE_INTERFACE)/sizeof(m_RESOURCE_INTERFACE[0]) << std::endl;
    std::cout << "\t" << "# resource types     : "
              << sizeof(m_RESOURCE_TYPE)/sizeof(m_RESOURCE_TYPE[0]) << std::endl;
...
OCStackResult PowerlightResource::sendNotification(void)
{
    OCStackResult sResult = OC_STACK_OK;
    if ( m_interestedObservers.size() > 0) {
        std::cout << "Notifying list "  << m_interestedObservers.size() << " of observers\n";
...
* @param queries  the query parameters for this call
*/
OCRepresentation PowerlightResource::get(QueryParamsMap queries)
{
    OC_UNUSED(queries);
...
* @return OCEntityHandlerResult ok or not ok indication
*/
OCEntityHandlerResult PowerlightResource::post(QueryParamsMap queries, const OCRepresentation& rep)
{
    OCEntityHandlerResult ehResult = OC_EH_OK;
    OC_UNUSED(queries);
...
* Check if the interface name is an registered interface name
*/
bool PowerlightResource::in_updatable_interfaces(std::string interface_name)
{
    for (unsigned int i=0; i < (sizeof(m_IF_UPDATE)/sizeof(m_IF_UPDATE[0])); i++)
    {
        if (m_IF_UPDATE[i].compare(interface_name) == 0)
...
* the entity handler
*/
OCEntityHandlerResult PowerlightResource::entityHandler(std::shared_ptr<OCResourceRequest> request)
{
    OCEntityHandlerResult ehResult = OC_EH_ERROR;
    //std::cout << "In entity handler for PowerlightResource " << std::endl;

    if(request)
    {
        std::cout << "In entity handler for PowerlightResource, URI is : "
                  << request->getResourceUri() << std::endl;
        ...
        if(requestFlag & RequestHandlerFlag::RequestFlag)
        {
            ...
            if(request->getRequestType() == "GET")
            {
                std::cout<<"PowerlightResource Get Request"<< std::endl;
            ...
            {
                std::cout <<"PowerlightResource Post Request"<<std::endl;
                bool  handle_post = true;
            ...
            {
                std::cout << "PowerlightResource unsupported request type (delete,put,..)"
                    << request->getRequestType() << std::endl;
                pResponse->setResponseResult(OC_EH_ERROR);
                OCPlatform::sendResponse(pResponse);
                ehResult = OC_EH_ERROR;
...
/*
 * class definition for class that handles /WarnLight
 *
 * This resource describes a binary switch (on/off).
 * The value is a boolean.
 * A value of 'true' means that the switch is on.
...
*/
class WarnlightResource : public Resource
{
    public:
        /*
         * constructor
         ...
         * @param resourceUri the uri for this resource
         */
        WarnlightResource(std::string resourceUri = "/WarnLight");

        /*
         * destructor
         */
         virtual ~WarnlightResource(void);
    ...
    private:
        ...
        /*
         * Make the payload for the retrieve function (e.g. GET) /WarnLight
         * This resource describes a binary switch (on/off).
         * The value is a boolean.
         * A value of 'true' means that the switch is on.
         * A value of 'false' means that the switch is off.
        ...
        /*
         * Parse the payload for the update function (e.g. POST) /WarnLight
        ...
        // member variables for path: "/WarnLight"
        std::vector<std::string>  m_var_value_if; // the value for the array attribute "if": The interface set supported by this resource
        std::string m_var_name_if = "if"; // the name for the attribute "if"
        std::string m_var_value_n; // the value for the attribute "n": Friendly name of the resource
        std::string m_var_name_n = "n"; // the name for the attribute "n"
...
* Constructor code
*/
WarnlightResource::WarnlightResource(std::string resourceUri)
{
    std::cout << "- Running: WarnlightResource constructor" << std::endl;
...
* Destructor code
*/
WarnlightResource::~WarnlightResource() { }

OCStackResult WarnlightResource::registerResource(uint8_t resourceProperty)
{
    OCStackResult result = OC_STACK_ERROR;
    EntityHandler cb = std::bind(&WarnlightResource::entityHandler, this,PH::_1);
    result = OCPlatform::registerResource(m_resourceHandle,
                                          m_resourceUri,
                                          m_RESOURCE_TYPE[0],
                                          m_RESOURCE_INTERFACE[0],
    ...
    if(OC_STACK_OK != result)
    {
        std::cerr << "Failed to register WarnlightResource." << std::endl;
        return result;
    }
    ...
    std::cout << "WarnlightResource:" << std::endl;
    std::cout << "\t" << "# resource interfaces: "
              << sizeof(m_RESOURCE_INTERFACE)/sizeof(m_RESOURCE_INTERFACE[0]) << std::endl;
    std::cout << "\t" << "# resource types     : "
              << sizeof(m_RESOURCE_TYPE)/sizeof(m_RESOURCE_TYPE[0]) << std::endl;
...
OCStackResult WarnlightResource::sendNotification(void)
{
    OCStackResult sResult = OC_STACK_OK;
    if ( m_interestedObservers.size() > 0) {
        std::cout << "Notifying list "  << m_interestedObservers.size() << " of observers\n";
...
* @param queries  the query parameters for this call
*/
OCRepresentation WarnlightResource::get(QueryParamsMap queries)
{
    OC_UNUSED(queries);
...
* @return OCEntityHandlerResult ok or not ok indication
*/
OCEntityHandlerResult WarnlightResource::post(QueryParamsMap queries, const OCRepresentation& rep)
{
    OCEntityHandlerResult ehResult = OC_EH_OK;
    OC_UNUSED(queries);
...
* Check if the interface name is an registered interface name
*/
bool WarnlightResource::in_updatable_interfaces(std::string interface_name)
{
    for (unsigned int i=0; i < (sizeof(m_IF_UPDATE)/sizeof(m_IF_UPDATE[0])); i++)
    {
        if (m_IF_UPDATE[i].compare(interface_name) == 0)
...
* the entity handler
*/
OCEntityHandlerResult WarnlightResource::entityHandler(std::shared_ptr<OCResourceRequest> request)
{
    OCEntityHandlerResult ehResult = OC_EH_ERROR;
    //std::cout << "In entity handler for WarnlightResource " << std::endl;

    if(request)
    {
        std::cout << "In entity handler for WarnlightResource, URI is : "
                  << request->getResourceUri() << std::endl;
        ...
        if(requestFlag & RequestHandlerFlag::RequestFlag)
        {
            ...
            if(request->getRequestType() == "GET")
            {
                std::cout<<"WarnlightResource Get Request"<< std::endl;
            ...
            {
                std::cout <<"WarnlightResource Post Request"<<std::endl;
                bool  handle_post = true;
            ...
            {
                std::cout << "WarnlightResource unsupported request type (delete,put,..)"
                    << request->getRequestType() << std::endl;
                pResponse->setResponseResult(OC_EH_ERROR);
                OCPlatform::sendResponse(pResponse);
                ehResult = OC_EH_ERROR;
...
OCEntityHandlerResult Output1Resource::post(QueryParamsMap queries, const OCRepresentation& rep)
{
	...
	// the member values have been updated already with the request data
  //--Modified code for controlling Automation pHat-----
  gpio_out1->write(m_var_value_value);
  //----------------------------------------------------
...
OCEntityHandlerResult Output2Resource::post(QueryParamsMap queries, const OCRepresentation& rep)
{
	...
	// the member values have been updated already with the request data
  //--Modified code for controlling Automation pHat-----
  gpio_out2->write(m_var_value_value);
  //----------------------------------------------------
    }
    return ehResult;
}
...
OCEntityHandlerResult Output3Resource::post(QueryParamsMap queries, const OCRepresentation& rep)
{
	...
	// the member values have been updated already with the request data
  //--Modified code for controlling Automation pHat-----
  gpio_out3->write(m_var_value_value);
  //----------------------------------------------------
    }
    return ehResult;
}
...
OCEntityHandlerResult Relay1Resource::post(QueryParamsMap queries, const OCRepresentation& rep)
{
	...
	// the member values have been updated already with the request data
  //--Modified code for controlling Automation pHat-----
  gpio_rel1->write(m_var_value_value);
  //----------------------------------------------------
    }
    return ehResult;
}
...
OCEntityHandlerResult Relay2Resource::post(QueryParamsMap queries, const OCRepresentation& rep)
{
	...
	// the member values have been updated already with the request data
  //--Modified code for controlling Automation pHat-----
  gpio_rel2->write(m_var_value_value);
  //----------------------------------------------------
    }
    return ehResult;
}
...
OCEntityHandlerResult Relay3Resource::post(QueryParamsMap queries, const OCRepresentation& rep)
{
	...
	// the member values have been updated already with the request data
  //--Modified code for controlling Automation pHat-----
  gpio_rel3->write(m_var_value_value);
  //----------------------------------------------------
    }
    return ehResult;
}
...
class IoTServer
{
    ...
    private:
        ...
        CommslightResource  m_CommsLightInstance;
        PowerlightResource  m_PowerLightInstance;
        WarnlightResource  m_WarnLightInstance;
...
IoTServer::IoTServer()
    :m_ADC1Instance(),
     ...
     m_ADC3Instance(),
     m_ADC4Instance(),
     m_CommsLightInstance(),
     m_PowerLightInstance(),
     m_WarnLightInstance(),
     m_input1Instance(),
     m_input2Instance(),
     m_input3Instance(),
...
OCStackResult IoTServer::registerResources(uint8_t resourceProperty)
{
    ...
    result = m_CommsLightInstance.registerResource(resourceProperty);
    if(OC_STACK_OK != result)
    {
        return result;
    }
    result = m_PowerLightInstance.registerResource(resourceProperty);
    if(OC_STACK_OK != result)
    {
        return result;
    }
    result = m_WarnLightInstance.registerResource(resourceProperty);
    if(OC_STACK_OK != result)
    {
        return result;
    }
